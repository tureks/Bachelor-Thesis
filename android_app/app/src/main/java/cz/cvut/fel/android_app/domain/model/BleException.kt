...
sealed class BleException(val message: String) {
    ...
    data object ConnectionTimeout : BleException("The connection timed out. Device may be out of range.")
    data object DeviceTurnedOff : BleException("The device was switched off.")
