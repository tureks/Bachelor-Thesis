...
interface StreamSegmentDao {
    ...
    suspend fun getByMeasurementId(measurementId: Int): List<StreamSegment>

    @Insert
    suspend fun insert(segment: StreamSegment): Long

    @Update
    suspend fun update(segment: StreamSegment)
}